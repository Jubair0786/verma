...
export default function Page() {
  ...
  return (
    <main className="flex flex-col gap-4 p-5 ">
      <h1 className="text-2xl text-yellow-400 font-semibold">My Orders</h1>
      {(!orders || orders?.length === 0) && (
        <div className="flex flex-col items-center justify-center gap-3 py-11">
          ...
          <h1 className="text-2xl text-red-700 font-semibold">You have no order</h1>
        </div>
      )}
      <div className="flex flex-col gap-3">
        {orders?.map((item, orderIndex) => {
          ...
          return (
            <div className="flex flex-col gap-2 bg-yellow-400 border rounded-lg p-4">
              <div className="flex flex-col gap-2">
                <div className="flex gap-3">
                  ...
                  <h3 className="bg-red-100 shadow-lg shadow-green-600 text-red-500 text-xs rounded-lg px-2 py-1 uppercase">
                    {item?.status ?? "pending"}
                  </h3>
