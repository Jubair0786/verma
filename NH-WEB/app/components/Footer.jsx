...
export default function Footer() {
  ...
  return (
    <footer className="relative flex flex-col gap-3 w-full bg-green-500 border-t p-5 md:p-10">
      <div className="border-b w-full flex flex-col md:flex-row md:justify-between gap-3">
        ...
        <div className="flex-1 flex flex-col md:flex-row justify-end gap-4">
          <div className="flex gap-2 items-center">
            ...
            <h2 className="text-sm text-red-500">+91 9896201957</h2>
          </div>
          <div className="flex gap-2 items-center">
            <Mail size={12} className="text-red-400" />
            <a href="mailto:himanshulakshay1327@gmail.com" className="text-sm text-red-400">
              himanshulakshay1327@gmail.com
            </a>
          </div>
          <div className="flex gap-2 items-center">
            <MapPin size={12} className="text-red-500" />
            <a href="https://www.google.com/maps?q=H 178,Guru fateh town,kharar,mohali" target="_blank" rel="noopener noreferrer" className="text-sm text-red-500 hover:text-gray-600">
              CHANDIGARH
            </a>
          </div>
        </div>
      ...
      {showScrollToTop && (
        <button 
          ...
          className="fixed bottom-10 right-10 bg-red-500 text-green-600 p-2 rounded-full shadow-lg hover:bg-gray-200 transition-colors duration-300"
          title="Scroll to Top"
        >
      ...
      <div className="absolute top-4 right-4 bg-red-600 text-green-500 p-1 rounded-full shadow-lg flex items-center space-x-1">
        
        <a href="https://powered-fitness-website.vercel.app/" target="_blank" rel="noopener noreferrer">
          <GiChart  size={24} className="text-green-500" />
        </a>
        
        <span className="text-xs font-semibold">ZYM</span>
      </div>
