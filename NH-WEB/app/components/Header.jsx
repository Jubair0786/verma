...
export default function Header() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-green-500 p-4 bg-opacity-65 backdrop-blur-2xl py-3 px-4 md:py-4 md:px-16 border-b flex items-center justify-between">
      <Link href={"/"}>
        <img className="h-8 md:h-10 hover:bg-green-400" src="/logo.png" alt="Logo" />
      </Link>
