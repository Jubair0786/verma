        ...
        {(collections?.length <= 2
          ...
          return (
            <div className="px-2" key={collection.id}> {/* Added key here */}
              <div className="flex gap-4 bg-green-400 p-7 w-full rounded-xl h-full">
                <div className="w-full flex flex-col gap-2">
                  ...
                  <div className="flex gap-4">
                    <Link href={`/collections/${collection?.id}`}>
                      <button className="bg-red-600 text-green-400 text-opacity-100 text-nowrap md:text-sm px-4 py-2 rounded-lg shadow-lg shadow-black">
                         <GiShop/>
                      </button>
                    </Link>
                  </div>
