...
export default function FeaturedProductSlider({ featuredProducts }) {
  ...
  return (
    <div className="overflow-hidden relative">
      {/* Background Image */}
      <div
        className="absolute inset-0 z-0 bg-cover bg-center md:bg-fixed responsive-background"
        style={{
          backgroundImage: `url(${backgroundImages[currentBackground]})`,
          backgroundSize: "cover", // Ensures image covers container
      ...
      <div className="absolute top-4 left-0 right-0 z-10 p-2 text-center text-red-600 font-bold">
        <div className="whitespace-nowrap animate-marquee">
          Exclusive Offer: Get 30% Off Your First Purchase! Shop Now
        </div>
      </div>
      ...
      {isFeaturedProductsAvailable ? (
            ...
            <div key={product.id}>
              <div className="flex flex-col-reverse md:flex-row gap-4 bg-opacity-80 p-5 md:px-24 md:py-20 w-full">
                ...
                <div>
                  <Link href={`/products/${product?.id}`}>
                    <img
                      className="h-[14rem] md:h-[23rem] w-full object-contain"
        ...
        <div className="relative z-10 flex items-center justify-center h-[23rem]">
          ...
          <p className="text-green-500 whitespace-nowrap animate-marquee"> As you can see, our featured products are coming soon</p>
        </div>
      )}
      ...
      <style jsx>{`
        ...
        @media (max-width: 768px) {
          .responsive-background {
            background-size: contain; /* Adjust for small screens */
